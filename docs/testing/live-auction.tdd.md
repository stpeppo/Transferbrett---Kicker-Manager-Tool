...
- Tests: bundled Node `--test --experimental-test-coverage tests/auction_logic.test.js tests/auction_build_integration.test.js` — 33/33 PASS at the recorded full-suite checkpoint.
